...
const Construction = () => {
  const challenges = [
    ...
    },
    {
      ...
      solution: "Dust-proof closures and seamless designs minimize cement and fly ash dust during transport"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 bg-gradient-to-b from-muted/50 to-background">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mb-8">
            Heavy-duty bulk bags engineered for demanding construction environments. Designed to handle cement, sand, gravel, aggregates, and fly ash with maximum durability and safety.
          </p>
      ...
      <section className="py-16 bg-muted">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-4 text-center">Recommended Products for Construction</h2>
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
            These bulk bag solutions are built for the tough demands of construction sites. All products are in stock and ready to ship.
          </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center">Key Features for Construction Applications</h2>

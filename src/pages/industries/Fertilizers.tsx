  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-6 border border-amber-200/50 shadow-sm">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-2">Hygroscopic Caking</h3>
            ...
            <div className="bg-white rounded-2xl p-6 border border-amber-200/50 shadow-sm">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-2">Oxidizer Hazards</h3>
                  <p className="text-muted-foreground text-sm mb-3">
            ...
            <div className="bg-white rounded-2xl p-6 border border-amber-200/50 shadow-sm">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-2">Chemical Corrosion</h3>
                  <p className="text-muted-foreground text-sm mb-3">
            ...
            <div className="bg-white rounded-2xl p-6 border border-amber-200/50 shadow-sm">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-2">Static Ignition</h3>
                  <p className="text-muted-foreground text-sm mb-3">
      ...
      <section className="py-16 bg-amber-50/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-3">Compare Our Fertilizer Bags</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
      ...
      <section className="py-16 bg-amber-50/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Learn more about selecting, customizing, and using bulk bags for fertilizer products.
            </p>
          </div>
